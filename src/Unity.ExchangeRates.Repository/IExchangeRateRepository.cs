...
namespace Unity.ExchangeRates.Repository
{
    public interface IExchangeRateRepository
    {
        ...
        Task<List<ExchangeRateHistory>> GetAllRatesByDateAsync(DateTime createdDate, CancellationToken cancellationToken);
        Task<bool> ExistsForRateDateAsync(DateTime rateDate, CancellationToken cancellationToken);
